...
def create_table():
    ...
    cur = conn.cursor()
    try:
        sql_script = 'CREATE TABLE ' + current_data + ' (Id varchar(30),current_data varchar(30),location varchar(30),village varchar(30),house_type varchar(30),square varchar(30),orientation varchar(30), decorate varchar(30),money varchar(30),decr varchar(30),per_square VARCHAR (30),year varchar(30),url varchar(300),page varchar(30))'
        print('first sql ' + sql_script)
        cur.execute(sql_script)
        sql_script = "ALTER TABLE `lianjia`.`" + current_data + "` MODIFY COLUMN `Id` int(30) NOT NULL FIRST,MODIFY COLUMN `square` int(30) NULL DEFAULT NULL AFTER `house_type`,MODIFY COLUMN `money` int(30) NULL DEFAULT NULL AFTER `decorate`,MODIFY COLUMN `per_square` VARCHAR(30) NULL DEFAULT NULL AFTER `money`,MODIFY COLUMN `page` int(30) NULL DEFAULT NULL AFTER `url`,ADD PRIMARY KEY (`Id`);"
        cur.execute(sql_script)
